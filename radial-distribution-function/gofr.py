...
ax1.plot(fcc[:,0]/10.,fcc[:,1],color=palette[4],linewidth=2.0,alpha=0.8,label="fcc")
#ax1.fill_between(fcc[:,0]/10.,0.,fcc[:,1],color=palette[4],alpha=0.15)
ax1.text(1.55,2.,"fcc", rotation='vertical')
ax2.plot(hcp[:,0]/10.,hcp[:,1],color=palette[6],linewidth=2.0,alpha=0.8,label="hcp")
#ax2.fill_between(hcp[:,0]/10.,0.,hcp[:,1],color=palette[6],alpha=0.15)
ax2.text(1.55,2.,"hcp", rotation='vertical')
ax3.plot(bcc[:,0]/10.,bcc[:,1],color=palette[0],linewidth=2.0,alpha=0.8,label="bcc")
#ax3.fill_between(bcc[:,0]/10.,0.,bcc[:,1],color=palette[0],alpha=0.15)
ax3.text(1.55,1.75,"bcc", rotation='vertical')
ax4.plot(liquid[:,0]/10.,liquid[:,1],color=palette[2],linewidth=2.0,alpha=0.8,label="liquid")
#ax4.fill_between(liquid[:,0]/10.,0.,liquid[:,1],color=palette[2],alpha=0.15)
ax4.text(1.55,1.5,"liquid", rotation='vertical')
...
#ax3.set_ylabel('$g(r)$', labelpad=100.)
ax3.text(-0.125, 5., '$g(r)$', ha='center', va='center', rotation='vertical')
...
ax1.set_yticklabels(np.array([0,2,4]).astype(int)) 
ax2.set_yticks([0,2,4]) 
ax2.set_yticklabels(np.array([0,2,4]).astype(int)) 
ax3.set_yticks([0,2,4]) 
ax3.set_yticklabels(np.array([0,2,4]).astype(int)) 
ax4.set_yticks([0,2,4]) 
ax4.set_yticklabels(np.array([0,2,4]).astype(int)) 
...
plt.savefig('gofr.png', bbox_inches='tight', dpi=300)
